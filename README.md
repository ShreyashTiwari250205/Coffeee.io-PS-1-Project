...
a) **Image Upload** : Upload two images in JPG, JPEG or PNG in a Streamlit-based UI.

b) **Image Comparison** : Calculates SSIM and MSE and displays visual difference between reference and captured image.

c) **Object Detection** : Detects and labels Faces, Smiles, and Eyes in uploaded images.

d) **Downloads** : Allows downloading annotated detection and comparison results through Streamlit interface.

e) **Built Using** : Streamlit, OpenCV, NumPy, Scikit-Image, Matplotlib, Pandas, Python, and VS Code.
